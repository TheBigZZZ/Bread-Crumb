...
SKIP_DIRS = {
    ...
    ".cargo", ".mypy_cache", ".pytest_cache", ".ruff_cache", ".turbo",
    "bundle.js", ".DS_Store",
}
...
CODE_EXTS = {
    ...
    ".vue", ".svelte", ".sh", ".bash", ".tf", ".dockerfile", ".makefile",
    ".env.example", ".lock", ".xml", ".gradle",
}
...
class FileIngester:
    ...
    def _is_code_file(self, path: Path) -> bool:
        ...
        return path.suffix.lower() in CODE_EXTS or path.name.lower().endswith(("dockerfile", "makefile"))
        ...
        for file_path in files:
            try:
                ...
                if total_size + len(file_content) > max_total:
                    ...
                    content_parts.append(f"\n... [context limit reached, {len(files) - len(content_parts)} files skipped]")
                    break
